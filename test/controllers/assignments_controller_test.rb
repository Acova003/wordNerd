...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference('Assignment.count') do
      post assignments_url, params: { assignment: { response: @assignment.response, word_1: @assignment.word_1, word_2: @assignment.word_2 } }
    end
  ...
  test "should update assignment" do
    patch assignment_url(@assignment), params: { assignment: { response: @assignment.response, word_1: @assignment.word_1, word_2: @assignment.word_2 } }
